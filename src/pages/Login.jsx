...
import emailLoginResult from '../api/auth/login';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-amber-50">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md max-h-screen">
        {/* Logo và tiêu đề */}
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Đăng nhập để khám phá thế giới ẩm thực</p>
        </div>
        ...
        <p className="text-center mt-6 text-gray-600">
          Chưa có tài khoản?{' '}
          <Link to={path.REGISTER} className="font-semibold text-orange-600 hover:text-orange-700">
            Đăng ký ngay
          </Link>
        </p>
      </div>
